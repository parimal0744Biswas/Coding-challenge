...
public class GlobalExceptionHandler
{
	...
	public ResponseEntity<MyErrorDetails> todoExceptionHandler(TodoException be, WebRequest req)
	{
	...
	public ResponseEntity<MyErrorDetails> datanotFoundExceptionHandler(DataNotFoundException be, WebRequest req)
	{
		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), be.getMessage(), req.getDescription(false));
